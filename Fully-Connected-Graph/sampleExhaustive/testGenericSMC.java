	...
	public static void main(String args[]) throws Exception
	{
		...
		{			
			...
			for(int k=0; k<ConfigParameters.k_Value; k++)
			{
				...
				totalSampleCities[k] = totalSampleCities[k] + ConfigParameters.num_Nodes;
				fw.write(" " +Simulation.avgSatNodes[k] + " " + ConfigParameters.num_Nodes);
				//System.out.println(Simulation.avgSatNodes[k] + " " + ConfigParameters.num_Nodes);
			}	
